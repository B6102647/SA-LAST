...
// AddStatus adds the status edges to Book.
func (su *StatusUpdate) AddStatus(b ...*Book) *StatusUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveStatus removes status edges to Book.
func (su *StatusUpdate) RemoveStatus(b ...*Book) *StatusUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// AddStatus adds the status edges to Book.
func (suo *StatusUpdateOne) AddStatus(b ...*Book) *StatusUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveStatus removes status edges to Book.
func (suo *StatusUpdateOne) RemoveStatus(b ...*Book) *StatusUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
